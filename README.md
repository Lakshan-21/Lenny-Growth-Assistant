...
```mermaid
erDiagram
    AUTH_USERS ||--o| PROFILES : "extends (shared PK)"
    ...
    SESSIONS {
        uuid id PK
        uuid user_id FK
        text title "default 'New session'"
        timestamptz created_at
    ...
    MESSAGES {
        ...
        text content
        text skill_used "qa|research|ship30|artifact, null unless assistant"
        timestamptz created_at
    }
    EPISODES {
        uuid id PK
    ...
    TRANSCRIPT_CHUNKS {
        ...
        uuid episode_id FK
        text content
        vector_1024 embedding "bge-m3, HNSW cosine index"
        int start_offset
        int end_offset
    ...
    CITATIONS {
        ...
        text display_label "e.g. 'Episode 142 — 12:34-13:02'"
    }
    ARTIFACTS {
        uuid id PK
        uuid session_id FK
        ...
        text content_markdown "canonical source of truth, no content_html column"
        timestamptz created_at
    }
    RESEARCH_BRIEFS {
        uuid id PK
